...
function calculate() {
    // Pesquisa os elemento de entrada e saída do documento
    ...
    // Obtém a entrada do usuário através dos elementos de entrada.
    ...
    if(isFinite(monthly)) {
        ...
        // Salva a entrada do usuário para que possamos recuperá-la na próxima 
        // vez que ele visitar
        ...
        // Por fim, traça o gráfico do saldo devedor, dos juros e dos pagamentos 
        // do capital
...
// Passa a entrada do usuário para um script no lado do servidor que
// (teoricamente) pode retornar
// uma lista de links para financeiras locais interessadas em fazer empréstimos. 
// Este exemplo não contém uma implementação real desse serviço de busca de 
// financeiras. Mas se o serviço existisse, essa função funcionaria com ele.
